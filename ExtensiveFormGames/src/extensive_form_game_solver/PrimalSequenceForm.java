...
/**
 * Created by christiankroer on 3/17/17.
 */
...
public class PrimalSequenceForm  extends ZeroSumGameSolver {
    Game game;
    ...
    public PrimalSequenceForm(Game game, int playerToSolveFor) {
        this(game, playerToSolveFor, 1e-6);
    }

    public PrimalSequenceForm(Game game, int playerToSolveFor, double tol) {
        super(game);
        this.game = game;
        try {
